...
// ---------------------------------------------------------------------------
$BENCHMARK_QUESTION = "Provide a systems-engineering-grade analysis of municipal and state tax-base erosion when autonomous AI agents displace mid-skill knowledge-economy employment at scale.
 Given that individual income tax receipts fund roughly 40-50% of many U.S. state general funds, model the fiscal-year timeline over which a sustained 8% contraction in white-collar payroll 
 employment propagates into unemployment-insurance trust-fund depletion, reduced withholding receipts, and downgrade pressure on general-obligation municipal bonds. 
 Quantify the compounding effect where AI-driven productivity gains simultaneously suppress the wage growth used to project future receipts. Show the mechanism and the arithmetic at each 
 transition, not just the direction of travel.
";
